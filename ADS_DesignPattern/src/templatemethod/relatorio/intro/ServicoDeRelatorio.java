...
public class ServicoDeRelatorio {
	...
	public List<String> getVendasSemestral(Integer semestre) {
	    List<String> vendasSemestral = new ArrayList<>(); 

	    vendasSemestral.add("CATEGORIA DE PRODUTOS      | TOTAL SEMESTRAL");
	    vendasSemestral.add("Camisas Polo               |    42000,00");
	    vendasSemestral.add("Calças Jeans               |    23000,00");
	    vendasSemestral.add("Meias                      |    15240,00");
